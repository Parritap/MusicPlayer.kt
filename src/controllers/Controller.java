...
public class Controller implements Initializable {
    ...
    public List<Song> getFavorites(){
        ...
        song.setCover("/resources/mühür.jpg");
        ls.add(song);
        ...
        song.setCover("/resources/seniorita.jpg");
        ls.add(song);

        song = new Song();
        song.setName("Can't Help Falling in love");
        song.setArtist("Alvis Presley");
        song.setCover("/resources/cant_help_falling_in_love.jpg");
        ls.add(song);

        song = new Song();
        song.setName("Friend");
        song.setArtist("Justin Biber");
        song.setCover("/resources/friendjpg.jpg");
        ls.add(song);

        song = new Song();
        song.setName("No Time To Die");
        song.setArtist("Billie Eilish");
        song.setCover("/resources/no_time_to_die.jpg");
        ls.add(song);
        ...
        song.setCover("/resources/wolves.jpg");
        ls.add(song);
